...
package com.huerta.app.util.cifrados;
...
public class DES_ECB {
    ...
    public static void main(String[] args) {
        String texto="123";
        String clave ="FujimoriLibertad";
        
        String textocifrado=DES_ECB.cifrar(texto, clave);
        String textodescifrado=DES_ECB.decifrar(textocifrado, clave);

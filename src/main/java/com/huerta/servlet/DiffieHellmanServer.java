...
@WebServlet(name = "DiffieHellmanServer", urlPatterns = {"/diffieHellmanServer"})
public class DiffieHellmanServer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                misessiSession.setAttribute("ClaveSecretaCompartidaDH", claveCompartida);
